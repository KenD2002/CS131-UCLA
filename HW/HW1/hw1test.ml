...
let my_computed_periodic_point_test2 = computed_periodic_point (=) (fun x -> -x) 2 (10) = 10
let my_computed_periodic_point_test4 = computed_periodic_point (=) (fun x -> -x) 4 (10) = 10
